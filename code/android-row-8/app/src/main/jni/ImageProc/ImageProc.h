...
int Java_hva_row8_Modules_Stream_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
//void Java_com_camera_simplemjpeg_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
void Java_hva_row8_Modules_Stream_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
